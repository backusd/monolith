...
Helium::Helium(const std::shared_ptr<DeviceResources>& deviceResources,
...
void Helium::Update(double timeDelta, const std::vector<std::shared_ptr<Atom>>& atoms, XMFLOAT3 boxDimensions)
{
